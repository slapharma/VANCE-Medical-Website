...
// Twitter `summary_large_image` accepts the same 1200×630 ratio used for
// OpenGraph; we duplicate (rather than re-export) so Next.js can statically
// analyse the runtime/size/contentType exports per file.
